...
plot_missing <- function(x, percent = TRUE) {	
  ...
  main_plot <- ggplot2::ggplot(na_count_all_tidy, 
    ...
    ggplot2::theme(axis.text.x = element_text(angle = 60, size=7,vjust = -0.05))
  ...
  missing_by_column_plot <- ggplot2::ggplot(na_count_by_column,
    ...
    ggplot2::theme(panel.grid.major.x = ggplot2::element_blank(),	
          ...
          axis.text.x = element_text(angle = 60, size = 7,vjust = -0.05))	
...
Thanks to CDC, all the natality datasets and fetal death datasets we downloaded don't have any missing values. All the "NA" s or empty rows were created by the column of the dataset's metadata. After deleting those empty rows, we got perfect datasets without any missing values.
